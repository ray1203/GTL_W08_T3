...
void FEngineLoop::Tick()
{
    ...
    const double targetFrameTime = 1000.0 / TargetFPS; // ?ïú ?îÑ?†à?ûÑ?ùò Î™©Ìëú ?ãúÍ∞? (Î∞?Î¶¨Ï¥à ?ã®?úÑ)
    ...
    while (bIsExit == false)
    {
        ...
        {
            TranslateMessage(&msg); // ?Ç§Î≥¥Îìú ?ûÖ?†• Î©îÏãúÏß?Î•? Î¨∏ÏûêÎ©îÏãúÏß?Î°? Î≥?Í≤?
            DispatchMessage(&msg);  // Î©îÏãúÏß?Î•? WndProc?óê ?†Ñ?ã¨
